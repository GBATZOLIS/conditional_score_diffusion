...
flags.DEFINE_enum("mode", "train", ["train", "test", "multi_scale_test", "compute_dataset_statistics", 'manifold_dimension', 'conditional_manifold_dimension', 'inspect_VAE'], "Running mode: train or test")
