...
def get_config():
  ...
  config.training.batch_size = 16 #256
  training.workers = 4
  ...
  model.checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/dimension_detection/experiments/mnist/unconditional/checkpoints/best/last.ckpt'
