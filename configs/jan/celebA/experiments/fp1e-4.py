...
def get_config():
  ...
  model.checkpoint_path = None #'/home/js2164/rds/hpc-work/repos/score_sde_pytorch/logs/celebA/fokker_planck/fp_1e-4/checkpoints/best/last.ckpt'
