...
def get_config():
 ...
 # training
  ...
  logging.log_name = f'VElogfp_256_bounded_e7_likweight_lin_{training.alpha_min}_{training.alpha_max}'
  logging.top_k = 5
