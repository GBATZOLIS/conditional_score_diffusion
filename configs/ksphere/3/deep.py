...
def get_config():
  ...
  logging.log_path = '/home/gb511/projects/manifold_dimension/ksphere/3' #'logs/ksphere/'
  logging.log_name = 'deep'
  logging.top_k = 5
  ...
  model.checkpoint_path = '/home/gb511/projects/manifold_dimension/ksphere/3/%s/checkpoints/best/last.ckpt' % logging.log_name
  model.sigma_max = 1e-2+1e-4
  model.sigma_min = 1e-2-1e-4
