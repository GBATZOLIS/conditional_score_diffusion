...
def get_config():
  ...
  model.checkpoint_path = '/home/gb511/projects/manifold_dimension/ksphere/5/%s/checkpoints/best/epoch=19916--eval_loss_epoch=126.187.ckpt.ckpt' % logging.log_name
