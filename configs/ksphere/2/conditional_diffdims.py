...
def get_config():
  ...
  logging.log_name = 'conditional_diffdims'
  logging.top_k = 5
  ...
  model.checkpoint_path = '/home/gb511/projects/manifold_dimension/ksphere/2/%s/checkpoints/best/epoch=16336--eval_loss_epoch=60.695.ckpt' % logging.log_name
  model.sigma_max_x = 4
