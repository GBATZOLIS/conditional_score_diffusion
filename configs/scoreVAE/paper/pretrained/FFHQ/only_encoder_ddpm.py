...
def get_config():
  ...
  logging.log_name = 'only_encoder_ddpm_VAE_KLweight_0.01'
  logging.top_k = 3
  ...
  training.prior_checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/scoreVAE/experiments/paper/pretrained/FFHQ_128/prior/checkpoints/best/last.ckpt' #if set to None, we should the last checkpoint.
  ...
  model.checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/scoreVAE/experiments/paper/pretrained/FFHQ_128/only_encoder_ddpm_VAE_KLweight_0.01/checkpoints/best/last.ckpt'
