...
def get_config():
  ...
  logging.log_name = 'Latent2DBeatGANsEncoder'
  logging.top_k = 3
  ...
  model.checkpoint_path = None #'/store/CIA/gb511/projects/scoreVAE/experiments/ffhq/BeatGANsEncoder_flatten_linear/checkpoints/best/epoch=106--eval_loss_epoch=281.685.ckpt'
  ...
  model.enc_channel_mult = (1, 2, 4)
  model.enc_pool = 'unflattened'
