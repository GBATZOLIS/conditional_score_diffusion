...
def get_config():
  ...
  logging.log_name = 'only_encoder_ddpm_plus_smld_VAE_KLweight_1e_m4_DiffDecoders_continuous_prior'
  logging.top_k = 3
  ...
  model.checkpoint_path = None #'/home/gb511/rds_work/projects/scoreVAE/experiments/gd_ffhq/only_encoder_ddpm_plus_smld_VAE_KLweight_0.01_DiffDecoders_continuous_prior/checkpoints/best/last.ckpt'
