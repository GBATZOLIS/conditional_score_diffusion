...
def get_config():
  ...
  logging.log_name = 'only_EfficientResNetEncoder_VAE_KLweight_0.01'
  logging.top_k = 3
  ...
  model.checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/scoreVAE/experiments/paper/pretrained/celebA_64/only_EfficientResNetEncoder_VAE_KLweight_0.01/checkpoints/best/last.ckpt'
