...
def get_config():
  ...
  model.checkpoint_path = '/store/CIA/gb511/projects/scoreVAE/experiments/CelebA_64/attribute_conditional/checkpoints/best/last.ckpt'
  ...
  model.model_channels: int = 128 #time_embed_channels
