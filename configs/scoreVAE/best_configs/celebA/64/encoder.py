...
def get_config():
  ...
  logging.log_path = '/home/gb511/rds_work/projects/scoreVAE/experiments/gd_ffhq' if config.server=='hpc' else '/store/CIA/gb511/projects/scoreVAE/experiments/CelebA_64' 
  ...
  model.checkpoint_path = '/store/CIA/gb511/projects/scoreVAE/experiments/ffhq/BeatGANsEncoder_flatten_linear_bigger_latent/checkpoints/best/last.ckpt'
