...
def get_config():
  ...
  model.checkpoint_path = None #'/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/dimension_detection/experiments/fixed_squares_manifold/%s/checkpoints/best/last.ckpt' % logging.log_name
