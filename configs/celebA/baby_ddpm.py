...
def get_config():
  ...
  training.continuous = True # this should probably be model
  training.reduce_mean = True # ? why mean not sum? why 1/2 in front of sum?
  ...
  model.num_scales = 1000 # should this be model or sampling?

  # model architecture
  model.name = 'ddpm'
  model.dropout = 0.1
  model.scale_by_sigma = False # ATM this is not working, should be fixed
  ...
  sampling.noise_removal = True # what is this?
  sampling.probability_flow = False
  sampling.snr = 0.16 
  # add option for langevin normalization
